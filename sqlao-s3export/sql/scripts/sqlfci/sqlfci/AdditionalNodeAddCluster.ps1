...
$DscConfigName = "AdditionalNodeAddCluster"
...
try {
    ...
    AdditionalNodeAddCluster -OutputPath $DscConfigDirectory -ConfigurationData $ConfigurationData -Credentials $ClusterSecureCredObject.Credential
